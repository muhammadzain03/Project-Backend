...
class UserService:
    ...
    def create_user(email:str, username:str, password:str, pictureURL:str | None, userDescriptionURL:str | None) -> bool:
        return UserModel._insert_user_db(email, username, password, pictureURL, userDescriptionURL)
